...
const HeroSection = () => {
    return (
        <div className='flex flex-col items-center justify-center min-h-[40vh]'>
            <h1 className='text-2xl md:text-5xl text-center mb-2 '>Take Control of Your Browsing Experience</h1>
            <p className='text-xl  w-2/3 text-center'>Take charge of your Chrome browsing experience with TabStacker and enjoy a more organized and efficient digital workspace.</p>
